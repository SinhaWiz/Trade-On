...
"[project]/src/app/api/saves/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const savesCollection = db.collection('saved_games');
        const saves = await savesCollection.find({
            playerEmail: email
        }).sort({
            updatedAt: -1
        }).limit(10).toArray();
...
async function POST(request) {
    try {
        const { email, playerId, name, gameState } = await request.json();
        if (!email || !gameState) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Email and game state are required'
            }, {
                status: 400
            });
        }
...
async function PUT(request) {
    try {
        const { saveId, gameState } = await request.json();
        if (!saveId || !gameState) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Save ID and game state are required'
            }, {
                status: 400
            });
        }
        ...
        const save = await savesCollection.findOne({
            id: saveId
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            save
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8defa7b8._.js.map